...
class Trader:
    ...
    def order_orchids(self, state):
        ...
        # Truncate if long
        if len(self.orchids_price) > 500:
            self.orchids_price = self.orchids_price[-500:]
        ...
        if orchids_avg_sell_price > 1200:
            if (import_buy_prc < orchids_avg_sell_price - 30):
                self.conversions = -curr_position
                self.orchids_weighted_sell_price = 0
                self.orchids_total_volume = 0
        elif orchids_avg_sell_price > 1150:
            if (import_buy_prc < orchids_avg_sell_price - 25):
                self.conversions = -curr_position
                self.orchids_weighted_sell_price = 0
                self.orchids_total_volume = 0
        elif orchids_avg_sell_price > 1100:
            if (import_buy_prc < orchids_avg_sell_price - 20):
                self.conversions = -curr_position
                self.orchids_weighted_sell_price = 0
                self.orchids_total_volume = 0
        elif orchids_avg_sell_price > 1050:
            if (import_buy_prc < orchids_avg_sell_price - 15):
                self.conversions = -curr_position
                self.orchids_weighted_sell_price = 0
                self.orchids_total_volume = 0
        elif orchids_avg_sell_price > 1000:
            if (import_buy_prc < orchids_avg_sell_price - 10):
                self.conversions = -curr_position
                self.orchids_weighted_sell_price = 0
                self.orchids_total_volume = 0
        elif orchids_avg_sell_price > 950:
            if (import_buy_prc < orchids_avg_sell_price - 5):
                self.conversions = -curr_position
                self.orchids_weighted_sell_price = 0
                self.orchids_total_volume = 0
        else:
            if (import_buy_prc < orchids_avg_sell_price - 3):
                self.conversions = -curr_position
                self.orchids_weighted_sell_price = 0
                self.orchids_total_volume = 0
